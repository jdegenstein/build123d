...
* The ^ operator is used to reference the Location (includes position and
  orientation information) at the beginning of the path with which to create
  the circular section used by the sweep operation. 
